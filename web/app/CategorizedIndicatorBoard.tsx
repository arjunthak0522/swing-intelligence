...
export default function CategorizedIndicatorBoard({ washout }: { washout: WashoutSnapshot }) {
  ...
  const meanings: Record<string, string> = {
    ...
    "Nasdaq Breadth Momentum Speed": mcVelocity.meaning || "Measures how quickly Nasdaq breadth momentum is changing, helping expose an early turn before slower breadth measures confirm.",
    ...
    "Rapid Breadth Participation Surge": zweig.meaning || "Looks for a rapid shift from broad selling to broad participation, a classic sign that market internals have changed character.",
    ...
    "Credit Risk Improvement": credit.meaning || "Tracks whether lower-quality corporate bonds are beginning to outperform higher-quality bonds, an early cross-asset sign that investors are becoming more willing to take risk.",
