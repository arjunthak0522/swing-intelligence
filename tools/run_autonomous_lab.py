...
from swing_intelligence.opportunity_score_stress import OpportunityStressConfig, run_opportunity_score_stress
...
def main():
    ...
    opportunity_stress_config = OpportunityStressConfig(
        first_test_year=2008, fold_years=2,
        ...
        min_trades_total=25, min_folds_with_trades=4,
        min_positive_edge_fold_fraction=0.60,
        random_iterations=100, min_random_percentile=0.80,
        min_random_superiority_fold_fraction=0.60,
    ...
    opportunity_stress = {"config": opportunity_stress_config.__dict__, "targets": {}}
    semantic_features = {}
    for symbol in TARGETS:
    ...
    for symbol in TARGETS:
        ...
        stress = summary["opportunity_score_stress"][symbol]
        print(
